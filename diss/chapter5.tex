...
\subsection{Experiment in Rio de Janeiro and São Paulo}
...
In order to measure the performance of a text classification model, there are several types of metrics that can help this process, depending of course the context of the task. Regarding binary classification tasks, the most common evaluation metrics used are precision, accuracy and F1-score which is the harmonic mean of the previous two. Above, it is described each of these metrics as well the mathematical equation used in its calculation.
...
\subsection{Experiment in New York City}
