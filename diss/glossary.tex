...
\newglossaryentry{Crowdsensing}{
	...
	description = {Technique used to collectively share and extract information from large groups of individuals in order to analyse, infer or even measure processes of common interest}
}
